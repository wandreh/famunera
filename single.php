...
include "sql_handler/product.php";
include "sql_handler/categories.php";
include "sql_handler/adverts.php";
include "sql_handler/forums.php";
include "sql_handler/blog.php";
...
<div class="webMain Index">
    ...
    <div class="floor_2 clearfix">
    	<div class="indexFeatured">
			...
			<?php
			$products=get_limited_items($con_key,0,10);
			foreach( $products as $product)
			{	
				include "addons/products.php";
			}
	...
	<div class="floor_2 clearfix">
    	<div class="indexFeatured">
        	<h2>Recomended Products</h2>
				<?php
					$products=get_limited_items($con_key,10,15);
					foreach( $products as $product)
					{	
						include "addons/products.php";
					}
        ...
        <div class="indexR">
        	<h2>Adverts</h2>
			<?php	
			$ads=get_limited_adverts($con_key,0,3);
			foreach( $ads as $ad)
			{		
				include "addons/adverts.php";
			}	?>
    ...
    <div class="floor_5">
        ...
        <div class="flBox_5">
				<?php
				$blogs= get_limited_blogs($con_key,0,4);
				foreach($blogs as $blog)
				{	
					include "addons/blogs.php";
				} ?>
        </div>
    </div>   
